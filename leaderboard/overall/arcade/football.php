...
<html lang="en">
    ...
    <head>
        <title>Arcade Leaderboard - Football</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">Football Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Football</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallArcadeLeaderboard($mongo_mng, "Football");
                                            $i = 1;
