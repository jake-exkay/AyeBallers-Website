<?php
/**
 * Arcade Leaderboard - Hole In The Wall
 * PHP version 7.2.34
 *
 * @category Page
 * @package  AyeBallers
...
<html lang="en">
    ...
    <head>
        <title>Arcade Leaderboard - Hole In The Wall</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">Hole In The Wall Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Hole In The Wall</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallArcadeLeaderboard($mongo_mng, "HoleInTheWall");
                                            $i = 1;
