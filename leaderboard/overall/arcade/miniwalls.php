...
<html lang="en">
    ...
    <head>
        <title>Arcade Leaderboard - Mini Walls</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">Mini Walls Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Mini Walls</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallArcadeLeaderboard($mongo_mng, "MiniWalls");
                                            $i = 1;
                                            ...
                                            foreach ($result as $player) {
                                                ...
                                                $wither_damage = $player->arcade->miniWalls->witherDamage;
                                                ...
                                                echo '<tr>';
                                                    ...
                                                    echo '<td>' . number_format($wither_damage) . '</td>';
                                                echo '</tr>'; 
                                                $i = $i + 1;
