<?php
/**
 * Arcade Leaderboard - Party Games
 * PHP version 7.2.34
 *
 * @category Page
 * @package  AyeBallers
...
<html lang="en">
    ...
    <head>
        <title>Arcade Leaderboard - Party Games</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">Party Games Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Party Games</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th>Position (Party Games 1 Wins)</th>
                                                <th>Name</th>
                                                <th>Party Games 1 Wins</th>
                                                <th>Party Games 2 Wins</th>
                                                <th>Party Games 3 Wins</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallArcadeLeaderboard($mongo_mng, "PartyGames");
                                            $i = 1;
                                            ...
                                            foreach ($result as $player) {
                                                ...
                                                echo '<tr>';
                                                    ...
                                                    echo '<td>' . number_format($p1_wins) . '</td>';
                                                    echo '<td>' . number_format($p2_wins) . '</td>';
                                                    echo '<td>' . number_format($p3_wins) . '</td>';
                                                echo '</tr>'; 
                                                $i = $i + 1;
