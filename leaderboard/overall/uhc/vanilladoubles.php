<?php
/**
 * UHC Leaderboard - Vanilla Doubles
 * PHP version 7.2.34
 *
 * @category Page
 * @package  AyeBallers
...
<html lang="en">
    ...
    <head>
        <title>UHC Leaderboard - Vanilla Doubles</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">UHC Vanilla Doubles Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px" action="nodiamonds.php">
                                <button class="btn btn-primary">No Diamonds</button><br>
                            </form>
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Vanilla Doubles</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallUhcLeaderboard($mongo_mng, "VanillaDoubles");
                                            $i = 1;
                                            ...
                                            foreach ($result as $player) {
                                                ...
                                                $kills = $player->uhc->vanilladoubles->kills;
                                                $wins = $player->uhc->vanilladoubles->wins;
                                                $deaths = $player->uhc->vanilladoubles->deaths;
                                                $heads_eaten = $player->uhc->vanilladoubles->headsEaten;
