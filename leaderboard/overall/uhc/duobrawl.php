...
<html lang="en">
    ...
    <head>
        <title>UHC Leaderboard - Duo Brawl</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">UHC Duo Brawl Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled="">Duo Brawl</button><br>
                            </form>
                        </div>
                        <hr>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallUhcLeaderboard($mongo_mng, "DuoBrawl");
                                            $i = 1;
