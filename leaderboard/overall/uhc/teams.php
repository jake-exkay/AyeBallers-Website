...
<html lang="en">
    ...
    <head>
        <title>UHC Leaderboard - Teams</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">UHC Teams Leaderboard</h1>
                        <div class="row">
                            <form style="padding-left: 10px" action="../uhc.php">
                                <button class="btn btn-primary">Solo</button><br>
                            </form>
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Teams</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallUhcLeaderboard($mongo_mng, "Teams");
                                            $i = 1;
