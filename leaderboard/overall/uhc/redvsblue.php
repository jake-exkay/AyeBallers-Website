...
<html lang="en">
    ...
    <head>
        <title>UHC Leaderboard - Red vs Blue</title>
    </head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <h1 class="event_font">UHC Red vs Blue Leaderboard</h1>
                        <div class="row">
                            ...
                            <form style="padding-left: 10px">
                                <button class="btn btn-secondary" disabled>Red vs Blue</button><br>
                            </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            $result = getOverallUhcLeaderboard($mongo_mng, "RedVsBlue");
                                            $i = 1;
                                            ...
                                            foreach ($result as $player) {
                                                ...
                                                $kills = $player->uhc->redvsblue->kills;
                                                $wins = $player->uhc->redvsblue->wins;
                                                $deaths = $player->uhc->redvsblue->deaths;
                                                $heads_eaten = $player->uhc->redvsblue->headsEaten;
