...
<html lang="en">
    ...
    <head>
        ...
        <title>AyeBallers Leaderboard - QuakeCraft</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <form style="margin-right: 10px;" action="../overall/quakecraft.php">
                                <button type="submit" class="btn btn-primary">Overall Leaderboard</button>
                            </form>

                            <form action="quakecraft.php">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                AyeBallers Leaderboard - QuakeCraft
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">     
                                        ...
                                        <tbody>
                                         ...
                                         <?php
                                            ...
                                            $result = getQuakeGuildLeaderboard($connection);
