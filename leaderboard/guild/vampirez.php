...
<html lang="en">
    ...
    <head>
        ...
        <title>AyeBallers Leaderboard - VampireZ</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <form style="margin-right: 10px;" action="../overall/vampirez.php">
                                <button type="submit" class="btn btn-primary">Overall Leaderboard</button>
                            </form>

                            <form action="vampirez.php">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                AyeBallers Leaderboard - VampireZ
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="leaderboard" class="table table-striped table-bordered table-lg" cellspacing="0" width="100%">     
                                        ...
                                        <?php
                                            ...
                                            $result = getVampirezGuildLeaderboard($connection);
