 ...
 */
	...
	function updatePlayerInDatabase($connection, $uuid, $name, $API_KEY) 
    {
        ...
        $gen_s = $player_decoded_url->player;
        $pb_s = $gen_s->stats->Paintball;
        $qc_s = $gen_s->stats->Quake;
        $ab_s = $gen_s->stats->Arena;
        $tkr_s = $gen_s->stats->GingerBread;
        $vz_s = $gen_s->stats->VampireZ;
        $walls_s = $gen_s->stats->Walls;
        $bw_s = $gen_s->stats->Bedwars;
        $tnt_s = $gen_s->stats->TNTGames;
