<?php
	...
	function updatePlayerInDatabase($connection, $uuid, $name, $API_KEY) {
		...
		// Get rank
		$staff_rank = !empty($player_decoded_url->player->rank) ? $player_decoded_url->player->rank : "None";
		$monthly_package_rank = !empty($player_decoded_url->player->monthlyPackageRank) ? $player_decoded_url->player->monthlyPackageRank : "None";
		$package_rank = !empty($player_decoded_url->player->packageRank) ? $player_decoded_url->player->packageRank : "None";
		$new_package_rank = !empty($player_decoded_url->player->newPackageRank) ? $player_decoded_url->player->newPackageRank : "None";
        ...
        $deaths_bowspleef_tnt = !empty($player_decoded_url->player->stats->TNTGames->deaths_bowspleef) ? $player_decoded_url->player->stats->TNTGames->deaths_bowspleef : 0;
        $coins_tnt = !empty($player_decoded_url->player->stats->TNTGames->coins) ? $player_decoded_url->player->stats->TNTGames->coins : 0;
        $deaths_wizards_tnt = !empty($player_decoded_url->player->stats->TNTGames->deaths_capture) ? $player_decoded_url->player->stats->TNTGames->deaths_capture : 0;
        $kills_wizards_tnt = !empty($player_decoded_url->player->stats->TNTGames->kills_capture) ? $player_decoded_url->player->stats->TNTGames->kills_capture : 0;
        $wins_bowspleef_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins_bowspleef) ? $player_decoded_url->player->stats->TNTGames->wins_bowspleef : 0;
        $wins_wizards_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins_capture) ? $player_decoded_url->player->stats->TNTGames->wins_capture : 0;
        $wins_tntrun_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins_tntrun) ? $player_decoded_url->player->stats->TNTGames->wins_tntrun : 0;
        $record_tntrun_tnt = !empty($player_decoded_url->player->stats->TNTGames->record_tntrun) ? $player_decoded_url->player->stats->TNTGames->record_tntrun : 0;
        $selected_hat_tnt = !empty($player_decoded_url->player->stats->TNTGames->new_selected_hat) ? $player_decoded_url->player->stats->TNTGames->new_selected_hat : 0;
        $assists_wizards_tnt = !empty($player_decoded_url->player->stats->TNTGames->assists_capture) ? $player_decoded_url->player->stats->TNTGames->assists_capture : 0;
        $deaths_tntrun_tnt = !empty($player_decoded_url->player->stats->TNTGames->deaths_tntrun) ? $player_decoded_url->player->stats->TNTGames->deaths_tntrun : 0;
        $winstreak_tnt = !empty($player_decoded_url->player->stats->TNTGames->winstreak) ? $player_decoded_url->player->stats->TNTGames->winstreak : 0;
        $wins_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins) ? $player_decoded_url->player->stats->TNTGames->wins : 0;
        $kills_tnttag_tnt = !empty($player_decoded_url->player->stats->TNTGames->kills_tntag) ? $player_decoded_url->player->stats->TNTGames->kills_tntag : 0;
        $wins_tnttag_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins_tntag) ? $player_decoded_url->player->stats->TNTGames->wins_tntag : 0;
        $points_wizards_tnt = !empty($player_decoded_url->player->stats->TNTGames->points_capture) ? $player_decoded_url->player->stats->TNTGames->points_capture : 0;
        $kills_pvprun_tnt = !empty($player_decoded_url->player->stats->TNTGames->kills_pvprun) ? $player_decoded_url->player->stats->TNTGames->kills_pvprun : 0;
        $wins_pvprun_tnt = !empty($player_decoded_url->player->stats->TNTGames->wins_pvprun) ? $player_decoded_url->player->stats->TNTGames->wins_pvprun : 0;
        $deaths_pvprun_tnt = !empty($player_decoded_url->player->stats->TNTGames->deaths_pvprun) ? $player_decoded_url->player->stats->TNTGames->deaths_pvprun : 0;
        $record_pvprun_tnt = !empty($player_decoded_url->player->stats->TNTGames->record_pvprun) ? $player_decoded_url->player->stats->TNTGames->record_pvprun : 0;

        if (alreadyInPlayerTable($connection, $uuid)) {
        	$query = "UPDATE player SET name = ?, kills_paintball = ?, wins_paintball = ?, kill_prefix_paintball = ?, coins_paintball = ?, deaths_paintball = ?, forcefield_time_paintball = ?, killstreaks_paintball = ?, shots_fired_paintball = ?, hat_paintball = ?, adrenaline_paintball = ?, endurance_paintball = ?, fortune_paintball = ?, godfather_paintball = ?, headstart_paintball = ?, superluck_paintball = ?, transfusion_paintball = ?, karma = ?, most_recent_game = ?, achievement_points = ?, rank_colour = ?, coins_quake = ?, deaths_quake = ?, kills_quake = ?, killstreaks_quake = ?, wins_quake = ?, kills_teams_quake = ?, deaths_teams_quake = ?, wins_teams_quake = ?, killstreaks_teams_quake = ?, highest_killstreak_quake = ?, shots_fired_teams_quake = ?, headshots_teams_quake = ?, headshots_quake = ?, shots_fired_quake = ?, distance_travelled_teams_quake = ?, distance_travelled_quake = ?, coins_arena = ?, coins_spent_arena = ?, keys_arena = ?, rating_arena = ?, damage_2v2_arena = ?, damage_4v4_arena = ?, damage_1v1_arena = ?, deaths_2v2_arena = ?, deaths_4v4_arena = ?, deaths_1v1_arena = ?, games_2v2_arena = ?, games_4v4_arena = ?, games_1v1_arena = ?, healed_2v2_arena = ?, healed_4v4_arena = ?, healed_1v1_arena = ?, kills_2v2_arena = ?, kills_4v4_arena = ?, kills_1v1_arena = ?, losses_2v2_arena = ?, losses_4v4_arena = ?, losses_1v1_arena = ?, wins_2v2_arena = ?, wins_4v4_arena = ?, wins_1v1_arena = ?, rank = ?, coins_tkr = ?, box_pickups_tkr = ?, coins_picked_up_tkr = ?, silver_trophy_tkr = ?, wins_tkr = ?, laps_completed_tkr = ?, gold_trophy_tkr = ?, bronze_trophy_tkr = ?, olympus_tkr = ?, junglerush_tkr = ?, hypixelgp_tkr = ?, retro_tkr = ?, canyon_tkr = ?, coins_vz = ?, human_deaths_vz = ?, human_kills_vz = ?, vampire_kills_vz = ?, vampire_deaths_vz = ?, zombie_kills_vz = ?, most_vampire_kills_vz = ?, human_wins_vz = ?, gold_bought_vz = ?, vampire_wins_vz = ?, coins_walls = ?, deaths_walls = ?, kills_walls = ?, losses_walls = ?, wins_walls = ?, assists_walls = ?, experience_bw = ?, coins_bw = ?, deaths_bw = ?, diamond_collected_bw = ?, iron_collected_bw = ?, gold_collected_bw = ?, emerald_collected_bw = ?, final_deaths_bw = ?, games_played_bw = ?, losses_bw = ?, kills_bw = ?, items_purchased_bw = ?, resources_collected_bw = ?, void_kills_bw = ?, void_deaths_bw = ?, beds_broken_bw = ?, winstreak_bw = ?, final_kills_bw = ?, wins_bw = ?, time_played = ?, network_exp = ?, deaths_bowspleef_tnt = ?, coins_tnt = ?, deaths_wizards_tnt = ?, kills_wizards_tnt = ?, wins_bowspleef_tnt = ?, wins_wizards_tnt = ?, wins_tntrun_tnt = ?, record_tntrun_tnt = ?, selected_hat_tnt = ?, assists_wizards_tnt = ?, deaths_tntrun_tnt = ?, winstreak_tnt = ?, wins_tnt = ?, kills_tnttag_tnt = ?, wins_tnttag_tnt = ?, points_wizards_tnt = ?, kills_pvprun_tnt = ?, wins_pvprun_tnt = ?, deaths_pvprun_tnt = ?, record_pvprun_tnt = ?, last_updated = now() WHERE UUID = '" . $uuid . "'";

	        if($statement = mysqli_prepare($connection, $query)) {
	            mysqli_stmt_bind_param($statement, "siisiiiiisiiiiiiiisisiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisiiiiiiiiiii", $name, $kills_paintball, $wins_paintball, $kill_prefix_paintball, $coins_paintball, $deaths_paintball, $forcefield_time_paintball, $killstreaks_paintball, $shots_fired_paintball, $hat_paintball, $adrenaline_paintball, $endurance_paintball, $fortune_paintball, $godfather_paintball, $headstart_paintball, $superluck_paintball, $transfusion_paintball, $karma, $most_recent_game, $achievement_points, $rank_colour, $coins_quake, $deaths_quake, $kills_quake, $killstreaks_quake, $wins_quake, $kills_teams_quake, $deaths_teams_quake, $wins_teams_quake, $killstreaks_teams_quake, $highest_killstreak_quake, $shots_fired_teams_quake, $headshots_teams_quake, $headshots_quake, $shots_fired_quake, $distance_travelled_teams_quake, $distance_travelled_quake, $coins_arena, $coins_spent_arena, $keys_arena, $rating_arena, $damage_2v2_arena, $damage_4v4_arena, $damage_1v1_arena, $deaths_2v2_arena, $deaths_4v4_arena, $deaths_1v1_arena, $games_2v2_arena, $games_4v4_arena, $games_1v1_arena, $healed_2v2_arena, $healed_4v4_arena, $healed_1v1_arena, $kills_2v2_arena, $kills_4v4_arena, $kills_1v1_arena, $losses_2v2_arena, $losses_4v4_arena, $losses_1v1_arena, $wins_2v2_arena, $wins_4v4_arena, $wins_1v1_arena, $rank, $coins_tkr, $box_pickups_tkr, $coins_picked_up_tkr, $silver_trophy_tkr, $wins_tkr, $laps_completed_tkr, $gold_trophy_tkr, $bronze_trophy_tkr, $olympus_tkr, $junglerush_tkr, $hypixelgp_tkr, $retro_tkr, $canyon_tkr, $coins_vz, $human_deaths_vz, $human_kills_vz, $vampire_kills_vz, $vampire_deaths_vz, $zombie_kills_vz, $most_vampire_kills_vz, $human_wins_vz, $gold_bought_vz, $vampire_wins_vz, $coins_walls, $deaths_walls, $kills_walls, $losses_walls, $wins_walls, $assists_walls, $experience_bw, $coins_bw, $deaths_bw, $diamond_collected_bw, $iron_collected_bw, $gold_collected_bw, $emerald_collected_bw, $final_deaths_bw, $losses_bw, $kills_bw, $items_purchased_bw, $resources_collected_bw, $games_played_bw, $void_kills_bw, $void_deaths_bw, $beds_broken_bw, $winstreak_bw, $final_kills_bw, $wins_bw, $time_played, $network_exp, $deaths_bowspleef_tnt, $coins_tnt, $deaths_wizards_tnt, $kills_wizards_tnt, $wins_bowspleef_tnt, $wins_wizards_tnt, $wins_tntrun_tnt, $record_tntrun_tnt, $selected_hat_tnt, $assists_wizards_tnt, $deaths_tntrun_tnt, $winstreak_tnt, $wins_tnt, $kills_tnttag_tnt, $wins_tnttag_tnt, $points_wizards_tnt, $kills_pvprun_tnt, $wins_pvprun_tnt, $deaths_pvprun_tnt, $record_pvprun_tnt);
	        ...
	        if($statement = mysqli_prepare($connection, $query)) {
	            mysqli_stmt_bind_param($statement, "ssiisiiiiisiiiiiiiisisiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisiiiiiiiiiii", $uuid, $name, $kills_paintball, $wins_paintball, $kill_prefix_paintball, $coins_paintball, $deaths_paintball, $forcefield_time_paintball, $killstreaks_paintball, $shots_fired_paintball, $hat_paintball, $adrenaline_paintball, $endurance_paintball, $fortune_paintball, $godfather_paintball, $headstart_paintball, $superluck_paintball, $transfusion_paintball, $karma, $most_recent_game, $achievement_points, $rank_colour, $coins_quake, $deaths_quake, $kills_quake, $killstreaks_quake, $wins_quake, $kills_teams_quake, $deaths_teams_quake, $wins_teams_quake, $killstreaks_teams_quake, $highest_killstreak_quake, $shots_fired_teams_quake, $headshots_teams_quake, $headshots_quake, $shots_fired_quake, $distance_travelled_teams_quake, $distance_travelled_quake, $coins_arena, $coins_spent_arena, $keys_arena, $rating_arena, $damage_2v2_arena, $damage_4v4_arena, $damage_1v1_arena, $deaths_2v2_arena, $deaths_4v4_arena, $deaths_1v1_arena, $games_2v2_arena, $games_4v4_arena, $games_1v1_arena, $healed_2v2_arena, $healed_4v4_arena, $healed_1v1_arena, $kills_2v2_arena, $kills_4v4_arena, $kills_1v1_arena, $losses_2v2_arena, $losses_4v4_arena, $losses_1v1_arena, $wins_2v2_arena, $wins_4v4_arena, $wins_1v1_arena, $rank, $coins_tkr, $box_pickups_tkr, $coins_picked_up_tkr, $silver_trophy_tkr, $wins_tkr, $laps_completed_tkr, $gold_trophy_tkr, $bronze_trophy_tkr, $olympus_tkr, $junglerush_tkr, $hypixelgp_tkr, $retro_tkr, $canyon_tkr, $coins_vz, $human_deaths_vz, $human_kills_vz, $vampire_kills_vz, $vampire_deaths_vz, $zombie_kills_vz, $most_vampire_kills_vz, $human_wins_vz, $gold_bought_vz, $vampire_wins_vz, $coins_walls, $deaths_walls, $kills_walls, $losses_walls, $wins_walls, $assists_walls, $experience_bw, $coins_bw, $deaths_bw, $diamond_collected_bw, $iron_collected_bw, $gold_collected_bw, $emerald_collected_bw, $final_deaths_bw, $games_played_bw, $losses_bw, $kills_bw, $items_purchased_bw, $resources_collected_bw, $void_kills_bw, $void_deaths_bw, $beds_broken_bw, $winstreak_bw, $final_kills_bw, $wins_bw, $time_played, $network_exp, $deaths_bowspleef_tnt, $coins_tnt, $deaths_wizards_tnt, $kills_wizards_tnt, $wins_bowspleef_tnt, $wins_wizards_tnt, $wins_tntrun_tnt, $record_tntrun_tnt, $selected_hat_tnt, $assists_wizards_tnt, $deaths_tntrun_tnt, $winstreak_tnt, $wins_tnt, $kills_tnttag_tnt, $wins_tnttag_tnt, $points_wizards_tnt, $kills_pvprun_tnt, $wins_pvprun_tnt, $deaths_pvprun_tnt, $record_pvprun_tnt);
	            mysqli_stmt_execute($statement);
	            return true;
	        } else {
