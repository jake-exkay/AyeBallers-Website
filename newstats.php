        ...
        <?php require "includes/navbar.php"; ?>
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    ...
                    <div class="card" style="background-image: url('assets/img/stats-bg.png'); background-repeat: no-repeat; background-size: cover;">
                        <div class="card-body">
                            <div class="row">
                                <center>
                                    <?php echo '<img alt="Player Avatar" style="height: 250px; width: auto;" src="https://crafatar.com/renders/body/' . $uuid . '"/>'; ?>
