                              ...
                              <div class="col-md-12">
                                    <div class="card mb-4">
                                          <div class="card-body">
                                                <div class="row">
                                                      <div class="col-md-3">
                                                            <h2><img alt="Player Avatar" style="box-shadow: 3px 3px 5px grey; height: 40px; width: auto;" src="https://crafatar.com/avatars/' . $uuid . '"/>  ' . $rank_with_name . '</h2>
                                                            <hr>
